...
class UrlHelperTest extends TestCase {
  ...
  public static function providerTestParse() {
    return [
      ...
      [
        'http://www.example.com/my/path?my.destination=my.home&my destination=my home&my_destination[]=my.home&my_destination[]=my_home&my_destination[]=home',
        [
          'path' => 'http://www.example.com/my/path',
          'query' => [
            'my.destination' => 'my.home',
            'my destination' => 'my home',
            'my_destination' => ['my.home', 'my_home', 'home'],
          ],
          'fragment' => '',
        ],
      ],
