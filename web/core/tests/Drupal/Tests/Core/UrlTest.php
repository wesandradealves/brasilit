...
class UrlTest extends UnitTestCase {
  ...
  public function testGetUriForExternalUrlWithParameters() {
    $url = Url::fromUri('http://www.example.com/my/path?my.destination=my.home&my destination=my home&my_destination[]=my.home&my_destination[]=my_home&my_destination[]=home');
    $this->assertEquals('http://www.example.com/my/path?my.destination=my.home&my destination=my home&my_destination[]=my.home&my_destination[]=my_home&my_destination[]=home', $url->getUri());
  }
